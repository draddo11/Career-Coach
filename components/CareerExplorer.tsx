  ...
  return (
    <div className="space-y-8">
      <Card>
        ...
        <p className="text-slate-400 mb-6">Upload or paste your resume/CV to discover related job titles and alternative career paths you might be a good fit for.</p>
