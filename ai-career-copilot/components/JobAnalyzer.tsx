...
import { analyzeJobMatch } from '../services/appService';
...
const JobAnalyzer: React.FC<JobAnalyzerProps> = ({ resumeText, setActiveFeature }) => {
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          <div className="flex flex-col gap-2">
            {hasResume ? (
              <ResumePreview resumeText={resumeText} setActiveFeature={setActiveFeature} className="flex-grow" />
            ) : (
              <AddResumeCTA setActiveFeature={setActiveFeature} className="flex-grow" />
            )}
          </div>
          <div className="flex flex-col gap-2">
